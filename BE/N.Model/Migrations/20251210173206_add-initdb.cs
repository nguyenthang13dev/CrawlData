        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsUpdateNewPass = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "BusinessId", "CCCD", "CanBoId", "ConcurrencyStamp", "CreatedBy", "CreatedDate", "CreatedId", "DeletedDate", "DeletedId", "DiaChi", "DonViId", "Email", "EmailConfirmed", "Gender", "GroupRole", "IsDeleted", "IsSSO", "IsUpdateNewPass", "LockoutEnabled", "LockoutEnd", "Name", "NgaySinh", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "Permissions", "PhoneNumber", "PhoneNumberConfirmed", "Picture", "SecurityStamp", "TwoFactorEnabled", "Type", "UpdatedBy", "UpdatedDate", "UpdatedId", "UserName" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), 0, null, null, null, "d7a025dc-52f8-4952-9530-01be86a1e8b8", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, null, null, "admin", true, 0, null, false, null, null, false, null, null, null, "ADMIN", "ADMIN", "AQAAAAIAAYagAAAAEJDXOPSRw916Q2P9ZoQatdCGJ+FxXJ367CMP8o0EQ3vU7FYsEVH+KhM6OXKRZTMo4A==", null, null, false, null, "c8c8a0d5-d31b-40d8-9bce-3a8d17aec38e", false, "Admin", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin" });
