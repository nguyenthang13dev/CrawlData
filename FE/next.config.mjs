...
const nextConfig = {
  images: {
    remotePatterns: [
      {
        protocol: 'https',
        hostname: 'cdn.tuyensinh247.com',
        port: '',
        pathname: '/**', // Cho phép tất cả các đường dẫn dưới hostname này
      },
      {
        protocol: 'https',
        hostname: 'img.loigiaihay.com',
        port: '',
        pathname: '/**',
      },
      {
        protocol: 'https',
        hostname: 'm.loigiaihay.com',
        port: '',
        pathname: '/**',
      },
    ],
        ...
        headers: [
          {
            ...
            value: "frame-ancestors 'self' http://localhost:3000 http://113.20.123.20:8888 https://cdn.tuyensinh247.com",
          },
        ],
      },
    ];
